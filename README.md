...
Figure 1: The above image shows that app passed all the Circle-ci checks < br / >
...
Figure 2: The above image shows that app passed the Circle-ci checkes but it failed the Sonar cloud check as we did not provide any unit tests. < br / >
...
Figure 3: The above image shows this app has no issues but, failed due to no unit tests. < br / >
